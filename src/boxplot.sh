...
python boxplot.py \
    -p ../../outputs/age_gender/hiv.ccr5_exp.pc/preprocess/hiv.ccr5_exp.pc.proc_phtp.tsv \
    -c ../../outputs/age_gender/hiv.ccr5_exp.pc/preprocess/hiv.ccr5_exp.pc.proc_cvrt.tsv \
    -g ../../inputs/genotypes/200hiv/dosage/MatrixEQTL/200HIV_dosage.gz \
    -i ../../inputs/genotypes/200hiv/dosage/MatrixEQTL/200HIV_variantInfo.gz \
    ...
    -o ../../outputs/age_gender/hiv.ccr5_exp.pc/qtlmapping/boxplot

# hiv ccr5 expression geometry mean
python boxplot.py \
    -p ../../outputs/age_gender/hiv.ccr5_exp.gm/preprocess/hiv.ccr5_exp.gm.proc_phtp.tsv \
    -c ../../outputs/age_gender/hiv.ccr5_exp.gm/preprocess/hiv.ccr5_exp.gm.proc_cvrt.tsv \
    -g ../../inputs/genotypes/200hiv/dosage/MatrixEQTL/200HIV_dosage.gz \
    -i ../../inputs/genotypes/200hiv/dosage/MatrixEQTL/200HIV_variantInfo.gz \
    ...
    -o ../../outputs/age_gender/hiv.ccr5_exp.gm/qtlmapping/boxplot
...
python boxplot.py \
    -p ../../outputs/age_gender/bcg.ccr5_exp.pc/preprocess/bcg.ccr5_exp.pc.proc_phtp.tsv \
    -c ../../outputs/age_gender/bcg.ccr5_exp.pc/preprocess/bcg.ccr5_exp.pc.proc_cvrt.tsv \
    -g ../../inputs/genotypes/300bcg/dosage/MatrixEQTL/300BCG.dosage.tsv.gz \
    -i ../../inputs/genotypes/300bcg/dosage/MatrixEQTL/300BCG.info.tsv.gz \
    ...
    -o ../../outputs/age_gender/bcg.ccr5_exp.pc/qtlmapping/boxplot
...
python boxplot.py \
    -p ../../outputs/age_gender/bcg.ccr5_exp.gm/preprocess/bcg.ccr5_exp.gm.proc_phtp.tsv \
    -c ../../outputs/age_gender/bcg.ccr5_exp.gm/preprocess/bcg.ccr5_exp.gm.proc_cvrt.tsv \
    -g ../../inputs/genotypes/300bcg/dosage/MatrixEQTL/300BCG.dosage.tsv.gz \
    -i ../../inputs/genotypes/300bcg/dosage/MatrixEQTL/300BCG.info.tsv.gz \
    ...
    -o ../../outputs/age_gender/bcg.ccr5_exp.gm/qtlmapping/boxplot
